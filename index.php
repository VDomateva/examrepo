...
<meta keywords="information technologies computers"/>
<meta description="This site is about information technologies."/>
...
<header class="wrapper bgded overlay style-header" >
      ...
      <div class="table-row"> 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-key"></i></a>
            ...
            <p class="para">Понятието „информационни технологии“ в съвременния си смисъл е използвано за пръв път през 1958 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-lastfm"></i></a>
            ...
            <p class="para">В центъра на информационните технологии е информацията – тяхната основна задача е автоматизиране и систематизиране на работата 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-angellist"></i></a>
            ...
            <p class="para">Информационните технологии използват за обработка и съхранение на информация електронноизчислителни машини – компютри. 
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-80">
      ...
      <p class="nospace pdisplay" >&fgdlgdgdfl gldfl gldfl glfld</p>
    </div>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper bgded overlay divwrapper">
  ...
  <section class="hoc container clear"> 
    ...
    <div class="group">
      <article class="one_third first"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt=""></a>
        ...
        <hr>
        <p class="para">По това време езикът и платформата Java, изградени върху същите концепции, се радват на огромен успех във всички сфери на разработката на софтуер и разработката на C# и .NET е естественият отговор на Microsoft срещу успехите на Java технологията.</p>
      ...
      <article class="one_third"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt=""></a>
        ...
        <hr>
        <p class="para">Тъй като оригиналната версия на езика C# и платформата .NET са само за Windows се появява проекта Mono. 
      ...
      <article class="one_third"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt=""></a>
        ...
        <hr>
        <p class="para">Mono сваля бариерите за създаване на качествен софтуер за Linux с езика C#. 
